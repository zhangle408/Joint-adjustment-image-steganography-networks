...
class UnetGenerator_fine_1(nn.Module):
    def __init__(self, input_nc, output_nc, num_downs, ngf=64,
                 norm_layer=None, use_dropout=False, use_tanh=1):
        super(UnetGenerator_fine_1, self).__init__()
    ...
    def forward(self, input, outc1, outc2, outc3, out_c3, out_c2, out_c1 ):
        ...
        # print('out_c3.shape', out_c3.shape)
        out_3 = out_3 + out_c3
        out_4_1 = out_3
        ...
        return out_1_1, out_2_1, out_3_1, out_4_1, out_5_1, out+out_c1,
